...
def health():
    ...
    quede claro que el bot no puede operar aunque el proceso responda.

    Ojo: este NO es el endpoint que usa el healthcheck de la plataforma (ese
    apunta a "/"). Ver el comentario en render.yaml.
